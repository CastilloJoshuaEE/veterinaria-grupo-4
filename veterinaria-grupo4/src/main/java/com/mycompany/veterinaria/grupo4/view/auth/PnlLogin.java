...
public class PnlLogin extends javax.swing.JLayeredPane {
    ...
    private void initLogin() {
        ...
        btnTogglePassword.setIcon(new ImageIcon(getClass().getResource("/icon/eye-off.png")));
        ...
        btnTogglePassword.setPreferredSize(new Dimension(35, 35));
        btnTogglePassword.addActionListener(e -> {
            if (txtPass.getEchoChar() == '\u2022' || txtPass.getEchoChar() == '*') {
                txtPass.setEchoChar((char) 0);
                btnTogglePassword.setIcon(new ImageIcon(getClass().getResource("/icon/eye.png")));
            } else {
                txtPass.setEchoChar('*');
                btnTogglePassword.setIcon(new ImageIcon(getClass().getResource("/icon/eye-off.png")));
            }
        ...
        passPanel.add(btnTogglePassword, BorderLayout.EAST);
